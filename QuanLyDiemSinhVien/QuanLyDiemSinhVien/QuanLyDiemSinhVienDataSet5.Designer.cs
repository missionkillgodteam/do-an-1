...
namespace QuanLyDiemSinhVien {
    ...
    public partial class QuanLyDiemSinhVienDataSet5 : global::System.Data.DataSet {
        ...
        public partial class LOGINDataTable : global::System.Data.TypedTableBase<LOGINRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LOGINRow AddLOGINRow(string TenDangNhap, string MatKhau, string HoTen, string GioiTinh, string Phone, string Email, string Quyen) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LOGINRow FindByTenDangNhapMatKhau(string TenDangNhap, string MatKhau) {
        ...
        public partial class LOGINRow : global::System.Data.DataRow {
            ...
            public string TenDangNhap {
                get {
                    return ((string)(this[this.tableLOGIN.TenDangNhapColumn]));
                }
                set {
                    this[this.tableLOGIN.TenDangNhapColumn] = value;
                }
            }
...
namespace QuanLyDiemSinhVien.QuanLyDiemSinhVienDataSet5TableAdapters {
    ...
    public partial class LOGINTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[LOGIN] WHERE (([TenDangNhap] = @Original_TenDangNhap) AND ([MatKhau] = @Original_MatKhau) AND ((@IsNull_HoTen = 1 AND [HoTen] IS NULL) OR ([HoTen] = @Original_HoTen)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Quyen = 1 AND [Quyen] IS NULL) OR ([Quyen] = @Original_Quyen)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[LOGIN] ([TenDangNhap], [MatKhau], [HoTen], [GioiTinh], [Phone], [Email], [Quyen]) VALUES (@TenDangNhap, @MatKhau, @HoTen, @GioiTinh, @Phone, @Email, @Quyen);
SELECT TenDangNhap, MatKhau, HoTen, GioiTinh, Phone, Email, Quyen FROM LOGIN WHERE (MatKhau = @MatKhau) AND (TenDangNhap = @TenDangNhap)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LOGIN] SET [TenDangNhap] = @TenDangNhap, [MatKhau] = @MatKhau, [HoTen] = @HoTen, [GioiTinh] = @GioiTinh, [Phone] = @Phone, [Email] = @Email, [Quyen] = @Quyen WHERE (([TenDangNhap] = @Original_TenDangNhap) AND ([MatKhau] = @Original_MatKhau) AND ((@IsNull_HoTen = 1 AND [HoTen] IS NULL) OR ([HoTen] = @Original_HoTen)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Quyen = 1 AND [Quyen] IS NULL) OR ([Quyen] = @Original_Quyen)));
SELECT TenDangNhap, MatKhau, HoTen, GioiTinh, Phone, Email, Quyen FROM LOGIN WHERE (MatKhau = @MatKhau) AND (TenDangNhap = @TenDangNhap)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TenDangNhap, MatKhau, HoTen, GioiTinh, Phone, Email, Quyen FROM dbo.LOGIN";
        ...
        public virtual int Fill(QuanLyDiemSinhVienDataSet5.LOGINDataTable dataTable) {
        ...
        public virtual QuanLyDiemSinhVienDataSet5.LOGINDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyDiemSinhVienDataSet5.LOGINDataTable dataTable = new QuanLyDiemSinhVienDataSet5.LOGINDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyDiemSinhVienDataSet5.LOGINDataTable dataTable) {
        ...
        public virtual int Delete(string Original_TenDangNhap, string Original_MatKhau, string Original_HoTen, string Original_GioiTinh, string Original_Phone, string Original_Email, string Original_Quyen) {
        ...
        public virtual int Insert(string TenDangNhap, string MatKhau, string HoTen, string GioiTinh, string Phone, string Email, string Quyen) {
            if ((TenDangNhap == null)) {
        ...
        public virtual int Update(string TenDangNhap, string MatKhau, string HoTen, string GioiTinh, string Phone, string Email, string Quyen, string Original_TenDangNhap, string Original_MatKhau, string Original_HoTen, string Original_GioiTinh, string Original_Phone, string Original_Email, string Original_Quyen) {
            if ((TenDangNhap == null)) {
                throw new global::System.ArgumentNullException("TenDangNhap");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HoTen, string GioiTinh, string Phone, string Email, string Quyen, string Original_TenDangNhap, string Original_MatKhau, string Original_HoTen, string Original_GioiTinh, string Original_Phone, string Original_Email, string Original_Quyen) {
            return this.Update(Original_TenDangNhap, Original_MatKhau, HoTen, GioiTinh, Phone, Email, Quyen, Original_TenDangNhap, Original_MatKhau, Original_HoTen, Original_GioiTinh, Original_Phone, Original_Email, Original_Quyen);
        }
    }
